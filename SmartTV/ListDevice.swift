...
class ListDevice: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        PhotoShareController.sharedInstance.eventAddService.asObservable().subscribe { _ in
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        print("\(PhotoShareController.sharedInstance.services.count)")
        self.tableView.reloadData()
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let item = PhotoShareController.sharedInstance.services[indexPath.row]
